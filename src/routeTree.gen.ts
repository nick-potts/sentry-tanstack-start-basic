...
const ApiBoomRoute = ApiBoomRouteImport.update({
  id: '/api-boom',
  path: '/api-boom',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  ApiBoomRoute: typeof ApiBoomRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api-boom': {
      ...
      path: '/api-boom'
      fullPath: '/api-boom'
      preLoaderRoute: typeof ApiBoomRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/_pathlessLayout': {
      id: '/_pathlessLayout'
